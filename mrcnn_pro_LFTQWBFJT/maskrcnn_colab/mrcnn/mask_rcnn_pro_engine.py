...
ROOT_DIR = os.path.abspath("E:\\zizi\\versi 6")
print("VERS 0.6 - 01/05/2023")
# Import Mask RCNN
...
def load_image_dataset(project_name):
    ...
    for file_path in annotations_files_path:
        dataset_train.load_custom(file_path, "E:\\zizi\\dataset\\arangtutup-sendiri\\", dataset_type='train')
        dataset_val.load_custom(file_path, "E:\\zizi\\dataset\\arangtutup-sendiri\\", dataset_type='val')
